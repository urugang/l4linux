...
#ifdef CONFIG_MMU
#ifdef CONFIG_L4
#define arm_copy_from_user l4x_copy_from_user
#define arm_copy_to_user l4x_copy_to_user
#define arm_clear_user l4x_clear_user
#endif /* L4 */
...
#ifdef CONFIG_L4
extern long l4x_strncpy_from_user(char *dest, const char __user *src, long count);
extern __must_check long l4x_strlen_user(const char __user *str);
extern __must_check long l4x_strnlen_user(const char __user *str, long n);
